<template>
  ...
  >
    ...
    <base-button type="submit" :is-loading="updateLoading"> Salvar </base-button>
  </base-account-modal>
...
const { isOpenDeleteModal, updateLoading, deleteLoading, handleDeleteModal, onSubmit, onDelete } =
